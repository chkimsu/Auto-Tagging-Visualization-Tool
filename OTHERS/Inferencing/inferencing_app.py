...
this is atvt inferencing_app code.
"""
...
model = ClassificationModel("bert", "bert-base-uncased",use_cuda = False, output_dir="new_outputs")

# "/data01/justinjang87/ATVT/Modeling/xlnet-advance/outputs/best_model/"
# """ Loading Saved_Model """/data01/justinjang87/ATVT/Modeling/xlnet-advance/__pycache__
model_xlnet = ClassificationModel('xlnet', '/data01/justinjang87/ATVT/Modeling/xlnet-advance/outputs/', num_labels=3, args=train_args, use_cuda=False)
#
# """ Train_data Setting """
...
#                             password=password_path, db=db_path, charset=charset_path, cursorclass=pymysql.cursors.DictCursor)
#     curs1 = conn1.cursor()
...
#     app.run(host=flask_host_path, port="15002", debug=flask_debug_setting)
